...
File file1 = new File("test1.txt");//File location is past as the path to the file as a parameter
Scanner scanFile = new Scanner(file1); //Creates a scanner for the file
...
FileWriter writer1 = new FileWriter("result1-1.txt"); //Uses the FileWriter tool
    
writer1.write("Reading Integers from the file: C:\\Users\\abeld\\Desktop\\School Work\\COP 3337.1\\Assignment3\\test1" + "\n");//Prints file location in the output file
  
writer1.write("Numbers of Integers in Interval [1-100]: " + counting + "\n"); //Prints the interval
  
writer1.write("Other Characters: " + otherChar + "\n"); // Prints the other characters
  
writer1.write("Histogram"); // Prints Histogram
...
writer1.close();//Closes writer1 to prevent data loss
