...
File file2 = new File("test2.txt");//File location is past as the path to the file as a parameter
Scanner scanFile = new Scanner(file2); //Creates a scanner for the file
...
FileWriter writer2 = new FileWriter("result1-2.txt"); //Uses the FileWriter tool
    
writer2.write("Reading Integers from the file: C:\\Users\\abeld\\Desktop\\School Work\\COP 3337.1\\Assignment3\\test2" + "\n");//Prints file location in the output file
  
writer2.write("Numbers of Integers in Interval [1-100]: " + counting + "\n"); //Prints the interval
  
writer2.write("Other Characters: " + otherChar + "\n"); // Prints the other characters
  
writer2.write("Histogram"); // Prints Histogram
...
writer2.close();//Closes writer2 to prevent data loss
